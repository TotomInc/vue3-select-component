...
function createKeyboardContext(overrides: Partial<SelectContext<string>> = {}): SelectContext<string> {
  return {
    ...
    showCreateItem: computed(() => false),
    createItemSearchValue: computed(() => ""),
    isCreateItemActive: computed(() => false),
    createItemElementId: "create-item",
    open: vi.fn(),
    close: vi.fn(),
    toggle: vi.fn(),
    select: vi.fn(),
    selectCreateItem: vi.fn(),
